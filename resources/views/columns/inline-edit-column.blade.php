    ...
    <div x-show="isEditing" class="flex items-center space-x-1" x-cloak>
        @if($isDateField)
            ...
            <input 
                ...
                class="border border-gray-300 dark:border-gray-600 rounded px-2 py-1 text-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 min-w-[180px] mr-2"
